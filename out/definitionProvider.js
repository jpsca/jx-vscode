...
class JxDefinitionProvider {
    async provideDefinition(document, position, _token) {
        ...
        const wordRange = document.getWordRangeAtPosition(position, RX_COMPONENT_TAG);
        if (!wordRange) {
            return undefined;
        }
    ...
    async resolveImportPath(importPath, currentFileUri) {
...
exports.JxDefinitionProvider = JxDefinitionProvider;
