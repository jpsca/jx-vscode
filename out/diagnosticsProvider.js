...
exports.JxDiagnosticsProvider = void 0;
const vscode = require("vscode");
const cp = require("child_process");
const path = require("path");
class JxDiagnosticsProvider {
    diagnosticCollection;
    disposables = [];
    constructor() {
        this.diagnosticCollection =
            vscode.languages.createDiagnosticCollection("jx");
        this.disposables.push(this.diagnosticCollection, vscode.workspace.onDidSaveTextDocument((doc) => {
    ...
    async checkFile(document) {
        ...
        return new Promise((resolve) => {
            cp.execFile(pythonPath, ["-m", "jx", "check", "--format", "json", filePath], { cwd, timeout: 10000 }, (error, stdout, _stderr) => {
...
exports.JxDiagnosticsProvider = JxDiagnosticsProvider;
